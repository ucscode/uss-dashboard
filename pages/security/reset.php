...
Events::instance()->addListener('udash:auth.right', function () use ($reset) { ?>
		...
		<div class="row py-3">
			<div class="col-sm-10 col-md-9 m-auto">
				...
				<?php
					...
					<?php Events::instance()->addListener('udash:auth/reset@form', function () { ?>
				...
				<?php
					...
					<?php Events::instance()->addListener('udash:auth/reset@form', function () use ($reset) { ?>
						...
						<input type='hidden' name='nonce' value='<?php echo Uss::instance()->nonce($_SESSION['resetter']); ?>'>
				...
				<?php Events::instance()->exec('udash:auth/reset@form', [$reset]); ?>
...
<?php Events::instance()->addListener('udash:auth.right', function () { ?>
	<div class="mt-4">
