...
Uss::instance()->tag('col.right', 'd-none');

Events::instance()->addListener('udash:auth.right', null);


/** Column Right */

Uss::instance()->tag('col.left', 'col-lg-12');

Events::instance()->addListener('udash:auth.left', function () { ?>
