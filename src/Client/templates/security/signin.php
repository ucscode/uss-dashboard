	...
	<form method='post' action="%{udash.ajax}" id='auth-form' data-type='ud-signin' enctype='multipart/form-data'>
		<div class="row py-3">
			<div class="col-sm-10 col-md-9 m-auto">
				...
				<?php Events::instance()->addListener('udash:auth/signin@form', function () { ?>
					<div class="mb-3">
				...
				<?php
                    Events::instance()->addListener('udash:auth/signin@form', function () {
                        /*
				...
				<?php Events::instance()->exec('udash:auth/signin@form'); ?>
