 ...
 * ```php
 *
 * Events::instance()->addListener('auth:left', function() {
 *	// content to display at left side
 * });
 *
 * // You can equally pass an id to override a content

 * Events::instance()->addListener('auth:right', function() {
 *	// content to display at right side
 * }, 'event-id');
 *
 * Uss::instance()->tag('auth.container', 'row');
 * Uss::instance()->tag('col.left', 'd-none');
 * Uss::instance()->tag('col.right', 'col-lg-12');
 *
...
<div class="%{col.row}">
	...
	<div class="%{col.left}">
		...
		<?php Events::instance()->addListener('udash:auth.left', function () { ?>
		...
		<?php Events::instance()->exec('udash:auth.left'); ?>
	...
	<div class="%{col.right}">
		...
		<div class="%{auth.container}">
			<div class="flex-grow-1">
				...
				<?php Events::instance()->exec('udash:auth.right'); ?>
