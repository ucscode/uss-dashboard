...
<main class="main-wrapper %{udash.main.class}">
	...
	<header class="header %{udash.header.class}">
		...
		<div class="container-fluid">
             ...
             */
            Events::instance()->exec('udash:header//left');
            ?>
					</div>
				</div>
                 ...
                 * ```
                 */
                Events::instance()->addListener('udash:header//right', function () {
             ...
             */
            Events::instance()->exec('udash:header//right');
            ...
            ?>
						...
						<div class="profile-box ml-1 %{udash.userdrop.class}">
							...
							<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
								<?php
                        if(!empty(Uss::instance()->tag('user.title'))):
                            /**
                             * Display user title
                             */
                            ?>
             ...
             */
            Events::instance()->exec('auth:header//userdrop');
            ?>
							</ul>
